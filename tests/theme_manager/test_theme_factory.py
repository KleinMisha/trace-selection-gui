...
from app.theme_manager.theme_factory import ThemeConfig, create_theme_controller
...
def test_resulting_controller_satisfies_protocol(qapp: QApplication) -> None:
    ...
    controller = create_theme_controller(None, ThemeConfig())
...
def test_view_is_placed_in_desired_placeholder(qapp: QApplication) -> None:
    ...
    controller = create_theme_controller(mock_placeholder, ThemeConfig())
