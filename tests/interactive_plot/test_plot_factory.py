...
from app.interactive_plot.plot_factory import (
    InterActivePlotConfig,
    create_plot_controller,
)
...
def test_resulting_controller_satisfies_protocol(qapp: QApplication) -> None:
    ...
    """
    controller = create_plot_controller(None, InterActivePlotConfig())
...
def test_view_is_placed_in_desired_placeholder(qapp: QApplication) -> None:
    ...
    controller = create_plot_controller(mock_placeholder, InterActivePlotConfig())
